function VotingWidget(options) {
    var THUMB_SVG = '<svg xmlns="http://www.w3.org/2000/svg" width="100%" height="100%" viewBox="0 0 24 23"><style type="text/css">.a{fill:none;stroke:#000000;stroke-width:1.2;stroke-miterlimit:10;}.b{fill:none;stroke:#000000;stroke-width:1.2;stroke-linecap:round;stroke-linejoin:round;stroke-miterlimit:10;}</style><path class="a thumb-part1" d="M3.1,9.4h1.6c0.9,0,1.7,0.7,1.7,1.6v9.8c0,0.9-0.7,1.6-1.7,1.6H3.1c-0.9,0-1.6-0.7-1.6-1.6V11C1.5,10.1,2.2,9.4,3.1,9.4z"/><path class="b thumb-part2" d="M6.6,10.8c0-0.3,0.1-0.7,0.3-0.9l3.5-5.1c0.8-1.7-0.3-3.4,1.6-3.8c3,0.4,2.4,7,2.4,7l5-0.7c0.9-0.1,1.7,0.5,1.9,1.4c0,0.1,0,0.1,0,0.2V11c1.1,0.5,1.6,1.9,1,3c-0.2,0.5-0.6,0.8-1,1c0.9,0.9,0.9,2.4-0.1,3.3c-0.2,0.2-0.5,0.4-0.8,0.5l0.2,1.7c0.1,0.9-0.5,1.8-1.4,1.9c-0.1,0-0.2,0-0.3,0H8.3c-0.9,0-1.7-0.7-1.7-1.7V10.8z"/></svg>';
