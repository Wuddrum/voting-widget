function VotingWidget(options) {
    var THUMB_SVG = '<svg xmlns="http://www.w3.org/2000/svg" width="100%" height="100%" viewBox="0 0 14.93 15.18"><defs><style>.a,.b{fill:none;stroke:#000;stroke-width:0.7px;}.a{stroke-miterlimit:10;}.b{stroke-linecap:round;stroke-linejoin:round;}</style></defs><title>thumbs2</title><rect class="a thumb-part1" x="0.35" y="5.72" width="3.36" height="9.1" rx="1.12"/><path class="b thumb-part2" d="M3.85,7A1.17,1.17,0,0,1,4,6.35L6.39,2.88C6.91,1.71,6.16.6,7.49.35c2,.27,1.6,4.73,1.6,4.73l3.37-.45a1.12,1.12,0,0,1,1.26,1s0,.1,0,.15V7.15a1.5,1.5,0,0,1,.7,2,1.46,1.46,0,0,1-.7.71,1.58,1.58,0,0,1-.06,2.23,1.65,1.65,0,0,1-.52.33l.17,1.11a1.12,1.12,0,0,1-.94,1.27l-.17,0H5a1.12,1.12,0,0,1-1.12-1.12Z"/></svg>';
